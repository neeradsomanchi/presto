...
import com.facebook.presto.ttl.fetcherManager.ConfidenceBasedTTLFetcherManager;
import com.facebook.presto.ttl.fetcherManager.TTLFetcherManager;
import com.facebook.presto.ttl.fetcherManager.TTLFetcherManagerConfig;
...
public class TestConfidenceMergingTTLFetcherManager
{
    ...
    {
        TTLFetcherManager ttlFetcherManager = new ConfidenceBasedTTLFetcherManager(
                nodeManager,
                new NodeSchedulerConfig().setIncludeCoordinator(true),
                new TTLFetcherManagerConfig());
